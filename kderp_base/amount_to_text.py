...
def amount_to_text_vn(number,curr='đồng',reserve=False):
    number = '%.2f' % number
    ...
    #cents_number = int(list[1])
        final_result = start_word + u' phẩy ' + end_word + curr #+  u' đồng'
    else:
...
def amount_to_text(nbr, lang='fr', currency='euro',reserve=False):
    """
